...
abstract final class ServiceNames {
  ...
  /// Returns the canonical Firestore document ID for a service name.
  static String documentIdFor(String name) => switch (name) {
    acServicing => 'ac_servicing',
    plumbing => 'plumbing',
    electrical => 'electrical',
    cleaning => 'cleaning',
    _ => throw ArgumentError.value(name, 'name', 'Unsupported service name.'),
  };
}
